...
Apartment::Translation.create(
  ...
  1900€/ mois + 450 de charges. (5 chambres / bail court possible prix sur demande)"
)
...
jules = Apartment.create(
  ...
  kitchen: true,
  availability: Date.parse("jan 1 2021"),
  description: "***Bedrooms #4 availble Jan 1st 2021.**** Nice apartment of 140 m2 in excellent condition, on the 7th and last floor, 6 bedrooms furnished with large closets, desk, bedding, 2 bathrooms, 2 toilets, kitchen (washing machine and dishwasher), very functional. American kitchen, living room.
...
lucie = Apartment.create(
  ...
  kitchen: true,
  availability: Date.parse("Jan 1 2021"),
  description: "*** bedroom left 550€ on Jan 1st 2021*** In the Vauban neighbourhood. Flatshare of  4 young professionals, very calm, non smoking.
...
Apartment::Translation.create(
  ...
  description: "*** chambre #2 libre 550€ on Jan 1st 2021 *** Quartier Vauban.colocation 4 jeunes actifs, très calmes, non fumeurs.
...
rollin = Apartment.create(
  ...
  description: "*** 1 bedrooms on 1st Sept 2020 *** In a beautiful recent apartment of 107m2, on the ground floor of a small condominium, 10 minutes from the station Tram Etoile, we offer 4 rooms for rent in individual contract. It is an international flat for young actives.\n
...
Apartment::Translation.create(
  ...
  nature: "coloc",
  description: "*** 1 chambre libre le 1er Sept 2020 *** Dans un bel appartement récent de 107m2, au RDC d'une petite copropriété, à 10 minutes de la station de Tram Etoile, nous proposons 4 chambres à louer en contrat individuel. Il s'agit d'une colocation internationale de jeunes actifs.\n
